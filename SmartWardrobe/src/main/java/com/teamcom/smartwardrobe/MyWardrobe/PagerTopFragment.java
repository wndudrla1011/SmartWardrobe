...
//        new Top_data("http://wndudrla1011.dothome.co.kr/Bring_Top_cloths.php",params).execute();
//
//    }
    ...
    public void onResume() {
        super.onResume();
        new Top_data("http://wndudrla1011.dothome.co.kr/Bring_Top_cloths.php", params).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
    ...
    public class Top_data extends AsyncTask<Void, Void, String> {
        String url;
        HashMap<String,String>  params;
        public Top_data(String url, HashMap<String,String> params) {
            this.url = url;
            this.params = params;
        }
