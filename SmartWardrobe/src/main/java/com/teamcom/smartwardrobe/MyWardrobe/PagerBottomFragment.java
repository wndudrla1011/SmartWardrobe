...
public class PagerBottomFragment extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        new Bottom_data("http://wndudrla1011.dothome.co.kr/Bring_Bottom_cloths.php",params).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
//    public void onResume() {
//        super.onResume();
//        items = new ArrayList<>();
...
//        new Top_data("http://wndudrla1011.dothome.co.kr/Bring_Bottom_cloths.php",params).execute();
//
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view =inflater.inflate(R.layout.viewpager_top, container, false);
        views = view;
        //카드뷰관련 리사이클뷰
    ...
    public class Bottom_data extends AsyncTask<Void, Void, String> {
        String url;
        HashMap<String,String>  params;
        public Bottom_data(String url, HashMap<String,String> params) {
            this.url = url;
            this.params = params;
        }
